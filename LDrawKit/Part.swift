...
open class Part {
	...
	private static let SUB_FILE_COMMAND_COUNT = 14
	private static let LINE_COMMAND_COUNT = 7
	private static let TRIANGLE_COMMAND_COUNT = 10
	private static let QUADRILATERAL_COMMAND_COUNT = 13
